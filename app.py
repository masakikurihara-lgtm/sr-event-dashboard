            ...
            for room_data in live_rooms_data:
                ...
                if gift_log:
                    for log in gift_log:
                        ...
                        point_calc = gift_point * gift_count if gift_point is not None and gift_count is not None else 0
                        
                        all_gift_log.append({
                            "ルーム名": room_name,
                            "時間": datetime.datetime.fromtimestamp(log.get('created_at', 0), JST),
