                ...
                if selected_enemy_room:
                    ...
                    if diff > 0:
                        st.markdown(
                            ...
                            f"<span style='font-size:1.6rem; font-weight:bold; color:#155724;'>{abs(diff):,}</span> pt <span style='font-size:1.4rem; font-weight:bold; color:#155724;'>リード</span>しています"
                        ...
                        st.markdown(
                            ...
                            f"<span style='font-size:1.6rem; font-weight:bold; color:#856404;'>{abs(diff):,}</span> pt <span style='font-size:1.4rem; font-weight:bold; color:#856404;'>ビハインド</span>です"
                            f"（対象: {target_point:,} pt / ターゲット: {enemy_point:,} pt）。 {lower_gap_text}</div>",
                            unsafe_allow_html=True
                        )
                    else:
                        st.markdown(
                            ...
                            f"ポイントは<span style='font-size:1.4rem; font-weight:bold; color:#0c5460;'>同点</span>です（<span style='font-size:1.6rem; font-weight:bold; color:#0c5460;'>{target_point:,}</span> pt）。 {lower_gap_text}</div>",
                            unsafe_allow_html=True
                        )
